...
_EIN_ and _NAME_—Identification columns

_APPLICATION_TYPE_—Alphabet Soup application type

_AFFILIATION_—Affiliated sector of industry

_CLASSIFICATION_—Government organization classification
